...
const GalleyMarketDashboard = () => {
  ...
  const getSegmentInfo = () => {
    switch (activeTab) {
      ...
      case "application": return { data: marketData.application, title: "Galley Type" };
      case "equipment": return { data: marketData.furnishedEquipment, title: "Furnished Equipment Type" };
      case "process": return { data: marketData.processType || [], title: "Insert Type" };
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <motion.footer initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="mt-12 border-t border-border pt-6">
          <div className="flex flex-col items-center justify-between gap-4 text-center md:flex-row md:text-left">
            <div>
              <p className="text-sm text-muted-foreground">Aircraft Galley Market Research Report</p>
