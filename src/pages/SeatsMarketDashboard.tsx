...
const SeatsMarketDashboard = () => {
  ...
  const getSegmentInfo = () => {
    switch (activeTab) {
      case "endUser": return { data: marketData.endUser, title: "Sales Type" };
      ...
      case "application": return { data: marketData.application, title: "Seat Class Type" };
      case "equipment": return { data: marketData.furnishedEquipment, title: "Component" };
      case "material": return { data: marketData.materialType || [], title: "Sales Channel Type" };
      default: return { data: marketData.endUser, title: "Sales Type" };
    }
  };
  ...
  const renderTabContent = () => {
    if (activeTab === "overview") {
      return (
        <MarketOverviewTab
          ...
          endUserLabel="Sales Type"
          equipmentLabel="Component"
          useMillions
        />
      );
    }
    ...
    return (
      <SegmentDetailTab
        ...
        endUserLabel="Sales Type"
        equipmentLabel="Component"
        applicationLabel="Seat Class Type"
        materialTypeLabel="Sales Channel Type"
        useMillions
      />
    );
  };
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <motion.footer initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="mt-12 border-t border-border pt-6">
          <div className="flex flex-col items-center justify-between gap-4 text-center md:flex-row md:text-left">
            <div>
              <p className="text-sm text-muted-foreground">Aircraft Seats Market Research Report</p>
